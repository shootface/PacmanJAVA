...
public class Board extends JPanel implements ActionListener{
    ...
    private Image ghost = new ImageIcon("src/gifs/Ghost1.gif").getImage();
    private Image ghost2 = new ImageIcon("src/gifs/Ghost2.gif").getImage();
    private Image Scaredghost = new ImageIcon("src/gifs/GhostScared1.gif").getImage();
    private Image Scaredghost2 = new ImageIcon("src/gifs/GhostScared2.gif").getImage();
    private Image pacman1 = new ImageIcon("src/gifs/./gifs/PMO.gif").getImage();
    private Image pacman2up = new ImageIcon("src/gifs/PMup1.gif").getImage(),pacman3up = new ImageIcon("src/gifs/PMup2.gif").getImage(),pacman4up = new ImageIcon("src/gifs/PMup3.gif").getImage();
    private Image pacman2down = new ImageIcon("src/gifs/PMdown1.gif").getImage(),pacman3down = new ImageIcon("src/gifs/PMdown2.gif").getImage(),pacman4down = new ImageIcon("src/gifs/PMdown3.gif").getImage();
    private Image pacman2left = new ImageIcon("src/gifs/PMleft1.gif").getImage(),pacman3left = new ImageIcon("src/gifs/PMleft2.gif").getImage(),pacman4left = new ImageIcon("src/gifs/PMleft3.gif").getImage();
    private Image pacman2right = new ImageIcon("src/gifs/PMright1.gif").getImage(),pacman3right = new ImageIcon("src/gifs/P./gifs/Mright2.gif").getImage(),pacman4right = new ImageIcon("src/gifs/PMright3.gif").getImage();
